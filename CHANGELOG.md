...
-   sqlfmt now supports `ALTER FUNCTION` and `DROP FUNCTION` statements ([#310](https://github.com/tconbeer/sqlfmt/issues/310), [#311](https://github.com/tconbeer/sqlfmt/issues/311))
